...
import { FaBriefcase, FaUserPlus, FaSignInAlt, FaSignOutAlt } from 'react-icons/fa'; 
            ...
            <div className="navbar-end gap-2">
                {
                    ...
                    (
                        ...
                        <>
                            ...
                            <NavLink 
                                className="btn btn-ghost text-gray-700 hover:bg-gray-100 hover:text-indigo-600 transition duration-200 hidden sm:flex" 
                                to="/signin"
                            >
                                <FaSignInAlt /> Sign In
                            </NavLink>
