    ...
    return (
        <div className="hero bg-gray-50 min-h-[70vh] py-16">
            <div className="hero-content flex-col lg:flex-row-reverse w-full max-w-6xl p-4">
                ...
                <div className="flex-1 relative h-100 w-full max-w-lg lg:max-w-none mb-12 lg:mb-0 hidden lg:block">
                ...
                <div className="flex-1 p-4 lg:p-0">
                    ...
                    >
                        The <span className="text-violet-700">Easiest Way</span> to Get Your{" "}
                        <span className="text-indigo-600"> New Job!</span>
                    </motion.h1>
