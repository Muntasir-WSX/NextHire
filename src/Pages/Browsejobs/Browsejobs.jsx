    ...
    return (
        <div className="min-h-screen py-12 bg-gray-50/50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {/* --- Hero Section: Heading + Floating 4 Images --- */}
                <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-20 bg-white p-8 md:p-16 rounded-[40px] shadow-2xl shadow-violet-100 border border-violet-50">
                    ...
                    {/* Right: Floating 4 Images Grid */}
                    <div className="lg:w-1/2 grid grid-cols-2 gap-6 relative">
                        <motion.img 
                            src={Engineer3} 
                            animate={floatingAnim(4)}
                            className="w-full h-44 object-cover rounded-[2rem] border-4 border-violet-500 shadow-2xl shadow-violet-200" 
                            alt="img" 
                        />
                        <motion.img 
                            src={Engineer2} 
                            animate={floatingAnim(5)}
                            className="w-full h-44 object-cover rounded-[2rem] border-4 border-indigo-400 mt-10 shadow-2xl shadow-indigo-200" 
                            alt="img" 
                        />
                        <motion.img 
                            src={Engineer4} 
                            animate={floatingAnim(4.5)}
                            className="w-full h-44 object-cover rounded-[2rem] border-4 border-fuchsia-400 -mt-10 shadow-2xl shadow-fuchsia-200" 
                            alt="img" 
                        />
                        <motion.img 
                            src={Engineer1} 
                            animate={floatingAnim(5.5)}
                            className="w-full h-44 object-cover rounded-[2rem] border-4 border-violet-600 shadow-2xl shadow-violet-300" 
                            alt="img" 
                        />
                    </div>
                </div>
